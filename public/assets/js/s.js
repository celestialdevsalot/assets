...
const presets = {
  ...
  clever: {
    title: "Clever | Portal",
    favicon: "https://assets.clever.com/launchpad/68edac15c/favicon.ico?1",
  },
  nt: { title: "New Tab", favicon: "https://raw.githubusercontent.com/GalacticNetwork/jmw-v6-archive/refs/heads/main/newtab.png" },
};
...
function applySettings() {
  ...
  if (typeof setPEngine === "function") {
    setPEngine(localStorage.getItem("pr0xy") || "scram");
  }
